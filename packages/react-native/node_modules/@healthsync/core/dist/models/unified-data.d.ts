 ...
 * @enum {string}
 */
export declare enum HealthSource {
 ...
 * @enum {string}
 */
export declare enum HeartRateContext {
    /** Resting heart rate */
    RESTING = "resting",
 ...
 * @enum {string}
 */
export declare enum SleepStage {
 ...
 */
export type AnyHealthData = StepsData | HeartRateData | SleepData | ActivityData | CaloriesData | DistanceData | BloodOxygenData | BloodPressureData | WeightData | HeartRateVariabilityData | VO2MaxData | UnifiedHealthData;
/**
 ...
 */
export declare function isDataType<T extends UnifiedHealthData>(data: UnifiedHealthData, type: DataType): data is T;
/**
 ...
 */
export declare function isValidHealthData(data: unknown): data is UnifiedHealthData;
//# sourceMappingURL=unified-data.d.ts.map